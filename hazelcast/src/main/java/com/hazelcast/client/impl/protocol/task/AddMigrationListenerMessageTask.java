...
public class AddMigrationListenerMessageTask
    ...
    protected CompletableFuture<UUID> processInternal() {
        ...
        final MigrationListener listener = new MigrationListener() {
            ...
            public void replicaMigrationCompleted(ReplicaMigrationEvent event) {
                if (endpoint.isAlive()) {
                    ClientMessage eventMessage = encodeMigrationEvent(event, true);
            ...
            public void replicaMigrationFailed(ReplicaMigrationEvent event) {
                if (endpoint.isAlive()) {
                    ClientMessage eventMessage = encodeMigrationEvent(event, false);
                    sendClientMessage(null, eventMessage);
                }
            }
        };
    ...
    @NotNull
    private ClientMessage encodeMigrationEvent(ReplicaMigrationEvent event, boolean success) {
